...
<form action="form4.html"method="POST">
        <legend><h1>formulir ppdb </h1> <legend>
    <p>
        <label>NISN :<label1>
...
<p>
    ...
    <input type="tempat" name="tempat">
</p>
<p> 
    <label> tanggal lahirn :</label>
...
<p>
 ...
 <p>
    ...
    <input type="asal sekolah" name="asal sekolah">
</p>
<p>
